...
# (1)leer los datos bajados del proyecto "biodiversidad-submarina-de-la-costa-argentina"
proyecto_obs <- read_csv("observations-339474.csv")
...
#Para obtener el data frame completo del usuario sin utilizar el API, bajamos de inaturalist el rchivo csv
library(readr)
...
años_deseados <- data.frame(Año = c(1980, 1982, 1993, 1995, 1996, 1997, 1999, 2001, 2002, 2003,
...
#juntar todos los mapas en un panel
library(htmltools)
library(shiny)
